...
import {FaGithub, FaLinkedin, FaTwitterSquare, FaInstagram, FaCodepen, FaFacebookF} from 'react-icons/fa'
import './Hero.css'
        ...
        <div className='hero' id='hero'>
            <div className='content'>
                ...
                <div className='social-medias'>
                    ...
                    <a href='https://www.linkedin.com/in/bilal-mubarak-idris-77b022212/' className='icons'>
                        <FaLinkedin className='icon' />
                    </a>
                    <a href="https://twitter.com/BilalMubarakId1" className='icons'>
                        <FaTwitterSquare  className='icon'/>
                    </a>
                    <a href="https://www.instagram.com/code_with_bilal/" className='icons'>
                        <FaInstagram className='icon' />
                    </a>
                    <a href="https://codesandbox.io/u/BILALMUBARAKIDRIS" className='icons'>
